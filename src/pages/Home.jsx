...
{/* ===== HÉRO ENCADRÉ ===== */}
<section className="mx-auto max-w-7xl px-4 pt-4 pb-6 sm:pt-5 sm:pb-8 lg:pt-6 lg:pb-12 -mt-2 sm:-mt-3 lg:-mt-4">
  ...
  <div className="rounded-3xl border border-slate-200 bg-white/85 shadow-md backdrop-blur supports-[backdrop-filter]:bg-white/70">
    <div className="grid items-start gap-4 md:gap-8 lg:gap-10 md:grid-cols-12 p-4 sm:p-6 lg:p-8">
      ...
      <div className="order-2 md:order-1 md:col-span-6">
        <p className="text-[22px] sm:text--[18px] font-extrabold uppercase tracking-wide text-blue-700">
          NEO CONSTRUCTION & TRAVAUX
        </p>

        <h1 className="mt-1 sm:mt-1 text-[14px] sm:text-[16px] md:text-2xl lg:text-2xl font-extrabold tracking-tight text-slate-900 leading-tight">
      ...
      <div className="order-1 md:order-2 md:col-span-6">
        {/* Hauteur mobile raisonnable pour garder le texte visible */}
        <div className="rounded-2xl overflow-hidden shadow-sm ring-1 ring-slate-200/60 h-[40vh] sm:h-[46vh] md:h-auto">
