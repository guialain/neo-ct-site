...
<section className="mx-auto max-w-7xl px-4 py-8 sm:py-10">
  <div className="grid gap-6 md:grid-cols-12 items-start">
    ...
    <div className="md:col-span-3">
      <div className="mx-auto md:mx-0 w-36 sm:w-44 md:w-48 lg:w-56">
        <img
          ...
          className="w-full h-auto rounded-xl border border-slate-200 shadow-sm
                     object-cover aspect-[3/4]"  // ratio pour éviter une image trop haute
          loading="lazy"
          decoding="async"
        />
      </div>
...
<div className="md:col-span-9">
      <h2 className="text-xl font-semibold text-slate-900">Mot du Directeur Général</h2>
